...
<?php 
 ...
 $acres                   =      1.16;
 $parcela                 =      $_POST['qntd_parcelas'];
 
  function calculo($valor_produto,$acres,$parcela){
      $resultado  =   (($valor_produto*$acres)/$parcela);
      return $resultado;
  }
 ?>
        ...
        <!--<h2>10.	Escreva um algoritmo que receba de entrada a distância total (em km) percorrida por um automóvel e a quantidade de combustível (em litros) consumida para percorrê-la, calcule e imprima o consumo médio de combustível.  Fórmula: Consumo médio = Km / litros.</h2> -->
            ...
            <div class="card card-info">
                ...
                <form name="form_calculo" id="form_calculo" action="" method="POST" class="form-horizontal">
                    ...
                    <div class="form-group row">
                        <label for="qntd_parcelas" class="col-sm-2 col-form-label">Valor daas parcelas</label>
                        <div class="col-sm-10">
                        <input type="number" min="1" max="12" class="form-control" id="qntd_parcelas" name="qntd_parcelas" placeholder="Ex.:10 x R$ 20,00 " required>
                        </div>
                    </div>
            ...
            echo "<br>Valor Original: R$".(number_format($valor_produto,2)) ;
            echo "<br>O Valor das parcelas é: R$ " .calculo($valor_produto,$acres,$parcela);          
            echo "<br> O valor padrão do aumento é : " ."16%";
            echo "<br> O valor com o aumento é : " .(number_format($valor_produto*$acres,2));
            ?>
